...
import { ReactNativeVsNativeContent } from "./content";
 ...
 */
const article = getArticle("react-native-vs-native");
  ...
  "@graph": [
    {
      ...
      keywords: [
        ...
        "react native 0.82 New Architecture default",
        "react native vs Swift and Kotlin",
        "how much code can you share react native",
        "rewriting a react native app in native",
      ],
...
export default function ReactNativeVsNativePage() {
  return (
    <>
      <script
