...
const defaultColors = ['#FFD400', '#FFFBE6', '#FFF3B0'];
...
export default function LiquidEther({
  ...
  useEffect(() => {
        ...
        super({
          material: {
            ...
            uniforms: {
              ...
              fboSize: { value: simProps.fboSize }, velocity: { value: (simProps.src as THREE.WebGLRenderTarget).texture },
    ...
    class Divergence extends ShaderPass {
      ...
      updatePass(opts: { vel?: THREE.WebGLRenderTarget }) {
        if (this.uniforms && opts.vel) this.uniforms.velocity.value = opts.vel.texture;
        super.update();
      }
    }
    ...
    class Poisson extends ShaderPass {
      ...
      updatePass(opts: { iterations?: number }) {
    ...
    class Pressure extends ShaderPass {
      ...
      updatePass(opts: { vel?: THREE.WebGLRenderTarget; pressure?: THREE.WebGLRenderTarget }) {
    ...
    class Simulation {
      ...
      update() {
        ...
        if (this.options.isViscous) {
          const v = this.viscous.updatePass({ viscous: this.options.viscous, iterations: this.options.iterations_viscous, dt: this.options.dt });
          if (v) vel = v;
        }
    ...
    class WebGLManager implements LiquidEtherWebGL {
      ...
      constructor(props: Record<string, unknown>) {
        ...
        this.autoDriver = new AutoDriver(Mouse, this, {
          enabled: props.autoDemo as boolean, speed: props.autoSpeed as number,
          resumeDelay: props.autoResumeDelay as number, rampDuration: props.autoRampDuration as number
        });
        this.init();
